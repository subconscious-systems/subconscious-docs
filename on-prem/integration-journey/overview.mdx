...
- **[Evaluation](/on-prem/integration-journey/evaluation)**: Align on use cases, security posture, ROI, expected usage, proof points, and whether you need the full inference system or OrangeLine only.
  - **Timeline**: 2-4 weeks.
  - **Ceremonies**: 2-4 meetings.
- **[Onboarding](/on-prem/integration-journey/onboarding)**: Plan deployment, stand up the chosen mode, configure the API Gateway when using the full system, and connect pilot users.
  - **Timeline**: 1-2 weeks.
