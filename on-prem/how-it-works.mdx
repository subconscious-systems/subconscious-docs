---
title: "How It Works"
description: "The API Gateway, Inference Runtime, and Distribution Platform behind The ORANGE Line"
icon: "diagram-project"
---

The ORANGE Line consists of three core components:
...
flowchart LR
  ...
  distr -->|"software delivery and updates"| gateway
  distr -->|"runtime releases"| runtime
```
...
The **Inference Runtime** is the GPU-backed execution layer that gives The ORANGE Line its efficiency advantage. It runs on customer-provided GPUs and is tuned for coding-agent workloads.
