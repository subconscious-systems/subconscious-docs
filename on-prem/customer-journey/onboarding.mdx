---
title: "Onboarding"
description: "From kickoff to pilot users on The ORANGE Line"
icon: "rocket"
---

Onboarding turns the evaluation plan into a working customer-hosted deployment. A Subconscious FDE works with your technical champion to deploy The ORANGE Line, configure the API Gateway, connect pilot users, and hand off day-two operations.

This page gives an overview. For implementation details, use [Methods](/on-prem/deployments/methods), [Configurations](/on-prem/deployments/configurations), and [API Gateway setup](/on-prem/deployments/gateway-setup).
...
- **Purpose**: Deploy The ORANGE Line into the customer's cloud environment.
- **What gets deployed**:
...
{/* TODO: Add screenshots for deployment status and initial API Gateway and Inference Runtime readiness. */}
...
See [API Gateway setup](/on-prem/deployments/gateway-setup) for the detailed setup guide.
