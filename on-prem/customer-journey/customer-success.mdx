...
Upgrade planning usually covers release notes, vulnerability evidence, compatibility, rollback process, maintenance windows, and customer communication. See [Distribution platform](/on-prem/deployment-models/distribution-platform) and [Configurations](/on-prem/deployment-models/configurations) for more detail.
