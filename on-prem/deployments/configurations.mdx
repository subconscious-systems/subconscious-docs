...
For the deployment method decision, start with [Methods](/on-prem/deployments/methods). For API Gateway dashboard setup after deployment, see [API Gateway setup](/on-prem/api-gateway/setup).
