...
Subconscious supports two primary deployment methods for customer-hosted production deployments: traditional self-hosted and assisted self-managed. Both keep The ORANGE Line in your environment. The difference is how installation, updates, and operational actions are performed.
...
- Coding agents use a customer endpoint backed by the API Gateway and configured model routes.
...
- [API Gateway setup](/on-prem/deployments/gateway-setup): API Gateway dashboard configuration after deployment.
