...
For long‑running tasks or when you need stronger durability guarantees, you can use async workflows with polling and webhooks. See the [Async jobs and webhooks](/platform/async-jobs-and-webhooks) guide for detailed examples of:
