...
<Tip>
  **Build with AI coding assistants:** Install our skill to let your coding agents learn the Subconscious API.
  
  ```bash
  npx skills add https://github.com/subconscious-systems/skills --skill subconscious-dev
  ```
  
  This gives Claude Code, Cursor, and other AI assistants deep knowledge of our API, so you can build your apps faster.
</Tip>
