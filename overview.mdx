...
## Engines
<CardGroup cols={2}>
  <Card title="TIM-large" icon="bolt" href="/engines">
    Highly capable generalized inference engine powered by GPT-4.1
  </Card>
  <Card title="TIM-small-preview" icon="microchip" href="/engines">
    Core TIM-8b model optimized for search and tool use
  </Card>
</CardGroup>
