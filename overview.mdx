...
Subconscious is an AI lab that makes open models dramatically more capable with a novel inference runtime and complementary post-training. Our API is fully OpenAI-compatible, so you can point the OpenAI SDK at our endpoint and start generating completions easily with two lines of code.
