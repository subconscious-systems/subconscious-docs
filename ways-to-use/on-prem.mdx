...
The full on-prem guide now lives in the dedicated On-Prem section. Start with the [On-Prem overview](/on-prem/overview) for the product readout, customer journey, deployment methods, API Gateway setup, and compliance details.
...
<Card title="Read the On-Prem guide" icon="book-open" href="/on-prem/overview">
  Learn how evaluation, onboarding, deployment models, API Gateway setup, and compliance work for customer-hosted deployments.
</Card>
